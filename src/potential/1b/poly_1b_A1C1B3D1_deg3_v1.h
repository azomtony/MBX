...
#ifndef POLY_1B_MBNRG_A1C1B3D1_DEG3_H
#define POLY_1B_MBNRG_A1C1B3D1_DEG3_H

/**
 * @file poly_1b_A1C1B3D1_deg3_v1.h
 * @brief Contains the structure of the polynomial for symmetry A1C1B3D1
 */
...
struct poly_A1C1B3D1_deg3_v1 {
    ...
    /**
     * @brief Evaluates the polynomial of degree 3 for A1C1B3D1 symmetry.
     *
     * Given the linear parameters and the value of the polynomial variables, 
     * evaluates the polynomial for the A1C1B3D1 symmetry.
...
#endif // POLY_1B_MBNRG_A1C1B3D1_DEG3_H
