...
#ifndef MBNRG_1B_A1C1B3D1_DEG3_V1_H
#define MBNRG_1B_A1C1B3D1_DEG3_V1_H
...
/**
 * @file mbnrg_1b_A1C1B3D1_deg3_v1.h
 * @brief Contains the structure of the polynomial holder for symmetry A1C1B3D1
 */

/**
 * @namespace mbnrg_A1C1B3D1_deg3
 * @brief Encloses the structure of the polynomial holder for symmetry A1C1B3D1
 */
...
struct mbnrg_A1C1B3D1_deg3_v1 {
    // Creates an empty class
    mbnrg_A1C1B3D1_deg3_v1() {};
     ...
     */
    mbnrg_A1C1B3D1_deg3_v1(const std::string mon1);

    // Destroys the class
    ~mbnrg_A1C1B3D1_deg3_v1() {};
    
    // Polynomial for this symmetry
    typedef poly_A1C1B3D1_deg3_v1 polynomial;
