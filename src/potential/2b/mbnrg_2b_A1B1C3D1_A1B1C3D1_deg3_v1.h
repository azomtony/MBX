...
#ifndef MBNRG_2B_A1B1C3D1_A1B1C3D1_DEG3_V1_H
#define MBNRG_2B_A1B1C3D1_A1B1C3D1_DEG3_V1_H
...
#include "poly_2b_A1B1C3D1_A1B1C3D1_deg3_v1.h" 


/**
 * @file mbnrg_2b_A1B1C3D1_A1B1C3D1_deg3_v1.h
 * @brief Contains the structure of the polynomial holder for symmetry A1B1C3D1_A1B1C3D1
 */

/**
 * @namespace mbnrg_A1B1C3D1_A1B1C3D1_deg3
 * @brief Encloses the structure of the polynomial holder for symmetry A1B1C3D1_A1B1C3D1
 */
...
struct mbnrg_A1B1C3D1_A1B1C3D1_deg3_v1 {
    // Creates an empty class
    mbnrg_A1B1C3D1_A1B1C3D1_deg3_v1() {};
     ...
     */
    mbnrg_A1B1C3D1_A1B1C3D1_deg3_v1(const std::string mon1, const std::string mon2);

    // Destroys the class
    ~mbnrg_A1B1C3D1_A1B1C3D1_deg3_v1() {};
    
    // Polynomial for this symmetry
    typedef poly_A1B1C3D1_A1B1C3D1_deg3_v1 polynomial;
