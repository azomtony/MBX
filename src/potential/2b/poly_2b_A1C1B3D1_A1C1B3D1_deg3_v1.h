...
#ifndef POLY_2B_MBNRG_A1C1B3D1_A1C1B3D1_DEG3_H
#define POLY_2B_MBNRG_A1C1B3D1_A1C1B3D1_DEG3_H

/**
 * @file poly_2b_A1C1B3D1_A1C1B3D1_deg3_v1.h
 * @brief Contains the structure of the polynomial for symmetry A1C1B3D1_A1C1B3D1
 */
...
struct poly_A1C1B3D1_A1C1B3D1_deg3_v1 {
    ...
    // Number of terms
    static const unsigned size = 1373;

    /**
     * @brief Evaluates the polynomial of degree 3 for A1C1B3D1_A1C1B3D1 symmetry.
     *
     * Given the linear parameters and the value of the polynomial variables, 
     * evaluates the polynomial for the A1C1B3D1_A1C1B3D1 symmetry.
     * @param[in] x Double array of length 66 with the variable values
     * @param[in] a Double array of 1373 elements with the linear parameters of the polynomial
...
#endif // POLY_2B_MBNRG_A1C1B3D1_A1C1B3D1_DEG3_H



//Polynomial input used to generate these files:

//  add_molecule['A1C1B3D1']
//  add_molecule['A1C1B3D1']
//  
...
//  add_variable['B', '3', 'a', 'C', '2', 'b', 'x-inter-B+C-0']
...
//  add_variable['B', '4', 'b', 'C', '1', 'a', 'x-inter-B+C-0']
//  add_variable['B', '4', 'b', 'C', '2', 'b', 'x-intra-B+C-1']
//  add_variable['B', '4', 'b', 'D', '1', 'a', 'x-inter-B+D-0']
//  add_variable['B', '4', 'b', 'D', '2', 'b', 'x-intra-B+D-1']
//  add_variable['B', '5', 'b', 'B', '6', 'b', 'x-intra-B+B-1']
//  add_variable['B', '5', 'b', 'C', '1', 'a', 'x-inter-B+C-0']
//  add_variable['B', '5', 'b', 'C', '2', 'b', 'x-intra-B+C-1']
//  add_variable['B', '5', 'b', 'D', '1', 'a', 'x-inter-B+D-0']
//  add_variable['B', '5', 'b', 'D', '2', 'b', 'x-intra-B+D-1']
//  add_variable['B', '6', 'b', 'C', '1', 'a', 'x-inter-B+C-0']
//  add_variable['B', '6', 'b', 'C', '2', 'b', 'x-intra-B+C-1']
//  add_variable['B', '6', 'b', 'D', '1', 'a', 'x-inter-B+D-0']
//  add_variable['B', '6', 'b', 'D', '2', 'b', 'x-intra-B+D-1']
...
//  add_variable['C', '2', 'b', 'D', '2', 'b', 'x-intra-C+D-1']
//  add_variable['D', '1', 'a', 'D', '2', 'b', 'x-inter-D+D-0']
//  
//  add_filter['sum-degree', 'x-inter-*+*-*', '0']
//  add_filter['sum-degree','*','3','and','sum-degree','x-*-*+B-*','2+']
//  
